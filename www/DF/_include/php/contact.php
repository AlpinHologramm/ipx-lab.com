...
class Contact_Form{
	...
	private function validateFields(){
		...
		if(!$this->name)
		{
			$this->response_html .= '<p>Veuillez insrire votre nom</p>';
		...
		if(!$this->email)
		{
			$this->response_html .= '<p>Veuillez inscrire votre adresse mail</p>';
			$this->response_status = 0;
		}
		...
		{
			$this->response_html .= '<p>Veuillez entrer une adresse mail valide</p>';
			$this->response_status = 0;
		}
