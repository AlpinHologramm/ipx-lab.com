...
define('CONF_KEY', '69Pe0L2oi77J906Ym1oY40O4scRV0l981Q042P72');
...
// Répertoires.
define('CONF_GALLERY_PATH', '/FL');
define('CONF_ADMIN_DIR', 'admin');
define('CONF_ALBUMS_DIR', 'albums');

// Paramètres GD.
define('CONF_GD_TRANSPARENCY', 1); # voir méthode gdTrans() dans includes/classes/img.class.php

// Paramètres de base de données.
define('CONF_DB_USER', 'ipxlabcoagmod1');
define('CONF_DB_PASS', 'polock27');
define('CONF_DB_DSN', 'mysql:host=mysql51-152.perso;dbname=ipxlabcoagmod1');
define('CONF_DB_PREF', 'ipx_');
